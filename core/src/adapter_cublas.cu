#include "../include/adapter_cublas.cuh"
    ...
    const BLAS_TRANSPOSE transpose_B)
{
    ...
    cublasDgemm(cublas, static_cast<cublasOperation_t>(transpose_B), static_cast<cublasOperation_t>(transpose_A), N, M, K, &alpha, d_B, N, d_A, K, &beta, d_C, N);
    ...
    const BLAS_TRANSPOSE transpose_A)
{
    ...
    cublasDtrsv(cublas, CUBLAS_FILL_MODE_UPPER, opposite(static_cast<cublasOperation_t>(transpose_A)), CUBLAS_DIAG_NON_UNIT, N, d_A, N, d_b, 1);
    ...
    const BLAS_TRANSPOSE transpose_A)
{
    ...
    cublasDgemv(cublas, opposite(static_cast<cublasOperation_t>(transpose_A)), N, M, &alpha_value, d_A, N, d_x, 1, &beta, d_y, 1);
