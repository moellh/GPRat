...
# cd $gprat_dir
# ./compile_gpxpy_python.sh -DGPXPY_WITH_CUDA=ON -DGPRAT_ASSEMBLY_ONLY=ON
...
# cd $gprat_dir
# ./compile_gpxpy_python.sh -DGPXPY_WITH_CUDA=ON -DGPRAT_PREDICT_STEPS=ON
# cd experiment/9-10-predict/
# mkdir -p apex-cpu
# mkdir -p apex-gpu
# ./run.sh
...
# cd $gprat_dir
# ./compile_gpxpy_python.sh -DGPXPY_WITH_CUDA=ON -DGPRAT_PREDICT_UNCER_STEPS=ON
# cd experiment/13-14-predict-uncer/
# mkdir -p apex-cpu
# mkdir -p apex-gpu
# ./run.sh
