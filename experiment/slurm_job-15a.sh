...
#SBATCH -w simcl1n1
#SBATCH --job-name="gp_15a"
#SBATCH --output=job_gprat-15a.out #SBATCH --time=24:00:00
#SBATCH --nodes=1
#SBATCH --exclusive
...
results_dir=$HOME/results/15a/${timestamp}
mkdir -p ${results_dir}
