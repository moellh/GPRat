...
#SBATCH -w simcl1n1
#SBATCH --job-name="gp_13b"
#SBATCH --output=job_gprat-13b.out #SBATCH --time=24:00:00
#SBATCH --nodes=1
#SBATCH --exclusive
...
# Test 13b
echo "=== Starting Test 13b"
cd $gprat_dir
./compile_gpxpy_python_simcl1.sh -DGPXPY_WITH_CUDA=ON
cd experiment/13-predict-uncer-ref/
./run_simcl1.sh
timestamp=$(date +"%m-%d_%H-%M-%S")
results_dir=$HOME/results/13b/${timestamp}
