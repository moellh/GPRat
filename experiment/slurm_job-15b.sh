...
#SBATCH -w simcl1n1
#SBATCH --job-name="gp_15b"
#SBATCH --output=job_gprat-15b.out #SBATCH --time=24:00:00
#SBATCH --nodes=1
#SBATCH --exclusive
...
# Test 15b
echo "=== Starting Test 15b"
cd $gprat_dir
./compile_gpxpy_python_simcl1.sh -DGPXPY_WITH_CUDA=ON
cd experiment/15-predict-fullcov-ref/
./run_simcl1.sh
timestamp=$(date +"%m-%d_%H-%M-%S")
results_dir=$HOME/results/15b/${timestamp}
